...
package org.tensorflow.demo.contrib;
...
/**
 * Wrapper over the TensorFlow API ({@code Graph}, {@code Session}) providing a smaller API surface
 * for inference.
 *
...
public class TensorFlowInferenceInterface {
    ...
    /**
     * Copy a byte sequence into the input Tensor with name {@code inputName} as a string-valued
    ...
    /**
     * Copy an array of byte sequences into the input Tensor with name {@code inputName} as a
